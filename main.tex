...
1. Jądro odpowiedzialne za siły zewnętrzne.\newline
\begin{verbatim}
...
\end{verbatim}
Oraz ciało funkcji ExternalForces():\newline
\begin{verbatim}
float2 ExternalForces(float2 pos, float2 velocity)
{
	return float2(0, gravity);
...
2. Jądro odpowiedzialne za przewidzenie pozycji cząstki
\begin{verbatim}
...
Badania zostały przeprowadzone przy użyciu unity profiler.
