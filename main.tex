...
\includepdf[pages=-]{MetodaSPH.drawio.pdf}
...
\includepdf[pages=-]{Tablica_skrotow.drawio-1.pdf}
...
Działanie symulacji można uznać za satysfakcjonujące.\newline
[screen wysoka gęstość]\newline
[niska gestosc]\newline
[brak grawitacji]\newline
[wysoka grawitacja]\newline
[wysoka sila lepkosci]\newline
[brak lepkosci]\newline
...
\begin{center}
    ...
    \caption{Rysunek 10: Czas wykonania poszczególnych jąder w metodzie siłowej}
    \label{wyniki_1}
\end{center}
\begin{center}
    \includegraphics[width=6.5in]{siła_skumulowany.png}
    \caption{Rysunek 11: Skumulowany czas wykonania jąder w metodzie siłowej}
    \label{wyniki_2}
\end{center}
...
\begin{center}
    ...
    \caption{Rysunek 12: Kompozycja klatki w metodzie siłowej}
    \label{wyniki_3}
\end{center}
...
\begin{center}
    ...
    \caption{Rysunek 13: Czas wykonania poszczególnych jąder z użyciem tablic mieszających}
    \label{wyniki_4}
\end{center}

\begin{center}
    \includegraphics[width=6.5in]{skumulowany.png}
    \caption{Rysunek 14: Skumulowany czas wykonania jąder z użyciem tablic mieszających}
    \label{wyniki_5}
\end{center}
...
\begin{center}
    ...
    \caption{Rysunek 15: Kompozycja klatki przy użyciu tablic mieszających}
    \label{wyniki_6}
\end{center}
...
\begin{center}
    ...
    \caption{Rysunek 16: Czas wykonania poszczególnych jąder z użyciem tablic mieszających z promieniem wygładzania = 0.6}
    \label{wyniki_7}
\end{center}
\begin{center}
    \includegraphics[width=6.5in]{1.png}
    \caption{Rysunek 17: Czas wykonania poszczególnych jąder z użyciem tablic mieszających z promieniem wygładzania = 1}
    \label{wyniki_8}
\end{center}
\begin{center}
    \includegraphics[width=6.5in]{zestawienie.png}
    \caption{Rysunek 18: Zestawienie całkowitego czasu symulacji dla różnych promieni wygładzania}
    \label{wyniki_9}
\end{center}
